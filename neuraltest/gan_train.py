...
#def train(epoch_count, batch_size, learning_rate, get_batches, data_shape, hidden_layer_shapes):
#    real_vector_size, synthetic_vector_size = data_shape
#    hidden_layer_shape_generator, hidden_layer_shape_discriminator = hidden_layer_shapes
#    input_real, input_z, lr = model_inputs(real_vector_size, synthetic_vector_size)
...
#                count += 1
#                z = np.random.uniform(-1, 1, size=(batch_size, synthetic_vector_size))
